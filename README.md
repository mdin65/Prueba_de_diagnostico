...
mmm no use docker sino que hice un localserver en la carpeta en donde tenemos este python y el html con este comando:

python -m http.server 8000 en el cmd
